...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-ListioTests/MGSwipeTableCell.framework"
  install_framework "Pods-ListioTests/NSDictionary_ANDYSafeValue.framework"
  install_framework "Pods-ListioTests/NSEntityDescription_SYNCPrimaryKey.framework"
